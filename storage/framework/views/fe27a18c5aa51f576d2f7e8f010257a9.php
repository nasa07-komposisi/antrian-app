...
<?php $__env->startSection('title', 'Tampilan Publik'); ?>
    ...
    <div class="row row-cols-1 row-cols-md-4 row-cols-lg-7 g-2 mb-4 px-1" id="counter-cards">
        <?php $__currentLoopData = $counters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $counter): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col">
                ...
                ?>
                <div class="card h-100 border-3 shadow-sm scale-hover" style="border-color: <?php echo e($hex); ?> !important;">
                    <div class="card-header text-white text-center py-2" style="background-color: <?php echo e($hex); ?> !important;">
                        <h4 class="mb-0 fw-bold"><?php echo e($counter->name); ?></h4>
                        <small class="badge bg-white mt-1 px-2 py-1" style="color: <?php echo e($hex); ?> !important; font-size: 0.7rem;">
                    ...
                    <div class="card-body text-center d-flex flex-column justify-content-center py-3">
                        <small class="text-muted mb-1 fw-bold letter-spacing-1" style="font-size: 0.75rem;">SEDANG
                            MELAYANI</small>
                        <div class="display-3 fw-bold mb-2 current-queue-number" style="color: <?php echo e($hex); ?> !important;">
                            <?php echo e($counter->queues->first()?->queue_number ?? '---'); ?>
                            ...
                            <div class="col-6 border-end">
                                ...
                                <?php
                                    $waitingCount = \App\Models\Queue::where('service_id', $counter->service_id)
                                        ...
                                        ->count();
                                ?>
                                <h5 class="mb-0 fw-bold waiting-count-number"><?php echo e($waitingCount); ?></h5>
                            </div>
                            <div class="col-6">
                                <small class="text-muted d-block text-uppercase fw-bold"
                                    style="font-size: 0.65rem;">Status</small>
                                <span class="badge rounded-pill"
                                    style="font-size: 0.65rem; background-color: <?php echo e($counter->status == 'busy' ? '#198754' : '#6c757d'); ?>">
                                    <?php echo e($counter->status == 'busy' ? 'AKTIF' : 'OFFLINE'); ?>
            ...
            <div class="card border-0 shadow-sm overflow-hidden">
                ...
                <div class="card-body bg-white py-4">
                    <div class="row g-4 justify-content-center" id="services-summary">
                        ...
                        ?>
                        <?php $__currentLoopData = $allServices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $svc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="col-6 col-md-3">
                                <div class="text-center p-3 border rounded-3 bg-light h-100">
                                    <div class="h1 fw-bold mb-0" style="color: <?php echo e($svc->hex_color); ?>">
                                        <?php echo e(\App\Models\Queue::where('service_id', $svc->id)->where('status', 'finished')->whereDate('finished_at', today())->count()); ?>

                                    </div>
                                    <div class="text-muted small text-uppercase fw-bold"><?php echo e($svc->name); ?></div>
    ...
    <?php $__env->startPush('scripts'); ?>
        <script>
            ...
            function updateStatus() {
                fetch('<?php echo e(route("public.status")); ?>')
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\930102850\.gemini\antigravity\scratch\antrian_app\resources\views/public/index.blade.php ENDPATH**/ ?>