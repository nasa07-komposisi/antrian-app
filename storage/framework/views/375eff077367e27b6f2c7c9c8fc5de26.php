...
<head>
    ...
    <title>Aplikasi Antrian - <?php echo $__env->yieldContent('title'); ?></title>
    <!-- Bootstrap CSS -->
...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark mb-4">
        <div class="container-fluid px-4">
            <a class="navbar-brand fw-bold" href="<?php echo e(route('public.index')); ?>">ANT APP</a>
            <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNav">
                <span class="navbar-toggler-icon"></span>
            </button>
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item"><a class="nav-link" href="<?php echo e(route('public.index')); ?>">Tampilan Publik</a></li>
                    <?php if(auth()->guard()->guest()): ?>
                        <li class="nav-item"><a class="nav-link" href="<?php echo e(route('login')); ?>">Dashboard Loket</a></li>
                        <li class="nav-item"><a class="nav-link" href="<?php echo e(route('admin.login')); ?>">Admin</a></li>
                    <?php else: ?>
                        <?php if(auth()->user()->role === 'staff'): ?>
                            <li class="nav-item"><a class="nav-link" href="<?php echo e(route('counter.index')); ?>">Dashboard Loket</a>
                            </li>
                        <?php else: ?>
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-dark dropdown-menu-end">
                                    ...
                                    <li><a class="dropdown-item" href="<?php echo e(route('admin.quotas')); ?>"><i
                                                class="bi bi-shield-check me-2"></i>Kuota Antrian</a></li>
                                    <li><a class="dropdown-item" href="<?php echo e(route('admin.services')); ?>">Layanan</a></li>
                                    <li><a class="dropdown-item" href="<?php echo e(route('admin.counters')); ?>">Loket</a></li>
                                    <li><a class="dropdown-item" href="<?php echo e(route('admin.users')); ?>">User</a></li>
                                </ul>
                            </li>
                        <?php endif; ?>
                    <?php endif; ?>
    ...
    <div class="<?php echo e(Request::is('/') || Request::is('admin*') || Request::is('counter*') ? 'container-fluid px-4' : 'container'); ?>">
    ...
    <script>
        ...
        (function () {
            ...
            function checkVersion() {
                ...
                fetch('<?php echo e(route("public.config-version")); ?>')
...
</html><?php /**PATH C:\Users\930102850\.gemini\antigravity\scratch\antrian_app\resources\views/layouts/app.blade.php ENDPATH**/ ?>