...
<?php $__env->startSection('content'); ?>
    <div class="row mb-4">
        <div class="col-md-12">
            ...
            ?>
            <?php if($unsetQuotas > 0): ?>
                <div class="alert alert-warning border-0 shadow-sm d-flex align-items-center mt-3">
                    <i class="bi bi-exclamation-triangle-fill fs-4 me-3"></i>
                    <div>
                        <strong>Perhatian:</strong> Ada <?php echo e($unsetQuotas); ?> layanan yang belum diatur kuotanya untuk hari ini.
                        Antrian tidak dapat diambil sampai kuota ditentukan.
                        <a href="<?php echo e(route('admin.quotas')); ?>" class="btn btn-warning btn-sm ms-3">Atur Sekarang</a>
                    </div>
                </div>
            <?php endif; ?>
        </div>
    ...
    <div class="row g-4 mb-5">
        <div class="col-md-12">
            <div class="card shadow-sm border-0">
                <div class="card-body bg-light rounded shadow-sm">
                    <form action="<?php echo e(route('admin.index')); ?>" method="GET" class="row g-3 align-items-end">
                        <div class="col-md-4">
            ...
            <div class="card bg-dark text-white shadow-sm border-0 h-100 border-start border-warning border-5">
                <div class="card-body d-flex align-items-center justify-content-between p-4">
                    <div>
                        ...
                        <h1 class="fw-bold mb-0 display-4"><?php echo e($totalQueues); ?></h1>
                    </div>
            ...
            <div class="card bg-dark text-white shadow-sm border-0 h-100 border-start border-success border-5">
                <div class="card-body d-flex align-items-center justify-content-between p-4">
                    <div>
                        ...
                        <h1 class="fw-bold mb-0 display-4"><?php echo e($finishedQueues); ?></h1>
                    </div>
        ...
        <div class="col-12 mt-4">
            ...
            <div class="d-flex gap-3 overflow-x-auto pb-3" style="scrollbar-width: thin;">
                <?php $__currentLoopData = $serviceStats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div style="flex: 1 1 0px; min-width: 250px;">
                        <div class="card shadow-sm border-0 h-100">
                            <div class="card-header border-0 text-white d-flex justify-content-between align-items-center py-3"
                                style="background: <?php echo e($stat['hex_color']); ?>">
                                <h6 class="mb-0 fw-bold text-truncate"><?php echo e($stat['name']); ?> (<?php echo e($stat['prefix']); ?>)</h6>
                            </div>
                            <div class="card-body">
                                <div class="row text-center g-0">
                                    <div class="col-6 border-end">
                                        ...
                                        <div class="h3 fw-bold mb-0 text-dark"><?php echo e($stat['total']); ?></div>
                                    </div>
                                    <div class="col-6">
                                        <div class="small text-muted text-uppercase mb-1" style="font-size: 0.7rem;">Terlayani
                                        </div>
                                        <div class="h3 fw-bold mb-0 text-success"><?php echo e($stat['finished']); ?></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-6 col-lg-3">
                    <div class="card bg-primary text-white shadow-sm border-0 h-100">
                        <div class="card-body text-center p-3">
                            ...
                            <h2 class="fw-bold mb-0"><?php echo e($serviceCount); ?></h2>
                        </div>
                    </div>
                </div>
                <div class="col-6 col-lg-3">
                    <div class="card bg-success text-white shadow-sm border-0 h-100">
                        <div class="card-body text-center p-3">
                            ...
                            <h2 class="fw-bold mb-0"><?php echo e($counterCount); ?></h2>
                        </div>
                    </div>
                </div>
                <div class="col-6 col-lg-3">
                    <div class="card bg-info text-white shadow-sm border-0 h-100">
                        <div class="card-body text-center p-3">
                            ...
                            <h2 class="fw-bold mb-0"><?php echo e($userCount); ?></h2>
                        </div>
                    </div>
                </div>
                <div class="col-6 col-lg-3">
                    <div class="card bg-warning text-dark shadow-sm border-0 h-100">
                        <div class="card-body text-center p-3">
                            ...
                            <h2 class="fw-bold mb-0"><?php echo e($activeCounterCount); ?></h2>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card shadow-sm border-0 h-100">
                ...
                <div class="card-body p-0">
                    <div class="list-group list-group-flush">
                        <a href="<?php echo e(route('admin.quotas')); ?>"
                        ...
                        <a href="<?php echo e(route('admin.users')); ?>" class="list-group-item list-group-item-action py-3">
                            <i class="bi bi-person-plus me-2 text-primary"></i> Manajemen Petugas Baru
                        </a>
                        <a href="<?php echo e(route('admin.services')); ?>" class="list-group-item list-group-item-action py-3">
                            <i class="bi bi-plus-square me-2 text-success"></i> Kelola Jenis Layanan
                        </a>
                        <a href="<?php echo e(route('admin.counters')); ?>" class="list-group-item list-group-item-action py-3">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\930102850\.gemini\antigravity\scratch\antrian_app\resources\views/admin/index.blade.php ENDPATH**/ ?>