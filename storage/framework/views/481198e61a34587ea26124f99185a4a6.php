                    ...
                    <table class="table table-hover mb-0">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td class="align-middle fw-bold px-3"><?php echo e($service->prefix); ?></td>
                                    <td class="align-middle"><?php echo e($service->name); ?></td>
                                    <td class="align-middle text-center">
                                        <div
                                            style="width: 30px; height: 30px; background-color: <?php echo e($service->hex_color); ?>; border-radius: 5px; display: inline-block; border: 1px solid #ddd;">
                                        </div>
                                    </td>
                                        ...
                                        <form action="<?php echo e(route('admin.services.update', $service->id)); ?>" method="POST">
                                            ...
                                            <div class="modal-content text-start">
                                                <div class="modal-header">
                                                    <h5 class="modal-title">Edit Layanan: <?php echo e($service->name); ?></h5>
                                                ...
                                                <div class="modal-body">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" name="name" class="form-control"
                                                            value="<?php echo e($service->name); ?>" required>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label class="form-label">Prefix Nomor</label>
                                                        <input type="text" name="prefix" class="form-control"
                                                            value="<?php echo e($service->prefix); ?>" maxlength="5" required>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label class="form-label">Warna HEX Kustom</label>
                                                        <input type="color" name="hex_color"
                                                            class="form-control form-control-color w-100"
                                                            value="<?php echo e($service->hex_color); ?>" title="Pilih warna layanan">
                                                        <input type="hidden" name="color_class" value="primary">
                                                    </div>
                                                    <div class="mb-3">
                                                        <label class="form-label">Deskripsi</label>
                                                        <textarea name="description" class="form-control"
                                                            rows="3"><?php echo e($service->description); ?></textarea>
                                                    </div>
                                                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\930102850\.gemini\antigravity\scratch\antrian_app\resources\views/admin/services.blade.php ENDPATH**/ ?>